      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600 text-lg">
            Quản lý và theo dõi các cuộc hẹn tư vấn giáo dục
          </p>
        </div>
            ...
            {appointments.length === 0 ? (
              <div className="text-center py-12">
                ...
                <p className="text-gray-400 text-sm mt-1">
                  Liên hệ với chuyên gia để đặt lịch hẹn
                </p>
              </div>
            ) : (
              appointments.map((app) => {
                ...
                return (
                  <div
                    key={app.id}
                    className="border border-gray-200 rounded-xl p-5 hover:shadow-md transition-shadow duration-200 bg-gradient-to-r from-gray-50 to-white"
                  >
                    <div className="space-y-3">
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <span
                          className={`px-3 py-1 rounded-full text-sm font-medium flex items-center gap-1 ${statusInfo.bg} ${statusInfo.color}`}
                        >
